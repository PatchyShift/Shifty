...
class Owner:
    ...
    async def owner(self, ctx):
        ...
        if self.bot.settings.no_prompt is True:
            await self.bot.say("Console interaction is disabled. Start SHIFT64 "
    ...
    async def prefix(self, ctx, *prefixes):
        """Sets SHIFT64's global prefixes
    ...
    async def serverprefix(self, ctx, *prefixes):
        """Sets SHIFT64's prefixes for this server
    ...
    async def stream(self, ctx, streamer=None, *, stream_title=None):
        """Sets SHIFT64's streaming status
    ...
    async def _blacklist_add(self, user: GlobalUser):
        """Adds user to SHIFT64's global blacklist"""
    ...
    async def _blacklist_remove(self, user: GlobalUser):
        """Removes user from SHIFT64's global blacklist"""
    ...
    async def whitelist(self, ctx):
        ...
        be able to use SHIFT64"""
        if ctx.invoked_subcommand is None:
            await self.bot.send_cmd_help(ctx)

    @whitelist.command(name="add")
    async def _whitelist_add(self, user: GlobalUser):
        """Adds user to SHIFT64's global whitelist"""
    ...
    async def _whitelist_remove(self, user: GlobalUser):
        """Removes user from SHIFT64's global whitelist"""
    ...
    async def restart(self, silently : bool=False):
        """Attempts to restart SHIFT64

        Makes SHIFT64 quit with exit code 26
    ...
    async def info(self):
        ...
        about = (
            "This is an instance of [SHIFT64, an open source Discord bot]"
        ...
        embed.add_field(name="About SHIFT64", value=about, inline=False)
        embed.set_footer(text="Bringing joy since 02 Jan 2018 (over "
    ...
    async def version(self):
        """Shows SHIFT64's current version"""
    ...
    def _get_version(self):
        if not os.path.isdir(".git"):
            msg = "This instance of SHIFT64 hasn't been installed with git."
